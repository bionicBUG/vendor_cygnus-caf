...
SIGNED_TARGET_FILES_PACKAGE := $(PRODUCT_OUT)/$(TARGET_DEVICE)-target_files-$(BUILD_NUMBER).zip
...
PROD_OTA_PACKAGE_TARGET := $(PRODUCT_OUT)/$(PACKAGE_VERSION).zip
...
.PHONY: cygnus
cygnus: $(PROD_OTA_PACKAGE_TARGET)

ifneq ($(PREVIOUS_TARGET_FILES_PACKAGE),)

INCREMENTAL_OTA_PACKAGE_TARGET := $(PRODUCT_OUT)/incremental-$(PACKAGE_VERSION).zip
